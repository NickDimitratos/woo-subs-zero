...
return array(
    ...
    'KM_Admin_Settings' => $baseDir . '/includes/admin/class-km-admin-settings.php',
    'KM_Admin_Subscriptions' => $baseDir . '/includes/admin/class-km-admin-subscriptions.php',
    'KM_Checkout_Handler' => $baseDir . '/includes/class-km-checkout-handler.php',
    'KM_Payment_Handler' => $baseDir . '/src/Payment/class-km-payment-handler.php',
    'KM_Paynl_Gateway' => $baseDir . '/src/Payment/Gateway/class-km-paynl-gateway.php',
    'KM_Renewal_Engine' => $baseDir . '/includes/class-km-renewal-engine.php',
    'KM_Retry_Manager' => $baseDir . '/includes/class-km-retry-manager.php',
    'KM_Subscription_Manager' => $baseDir . '/includes/class-km-subscription-manager.php',
    'KM_Webhook_Handler' => $baseDir . '/includes/class-km-webhook-handler.php',
    'KM_Woo_Subscriptions' => $baseDir . '/includes/class-km-woo-subscriptions.php',
